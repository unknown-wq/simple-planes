...
public final class ClientEventHandler {
     ...
     * client classpath and {@code InputConstants.Type.KEYSYM} was renamed {@code Type.KEYBOARD}.
     * The key numbers themselves come from {@link InputConstants}, which carries a full set of
     * {@code KEY_*} constants for the platform in use.
     */
    ...
    public static void registerKeyBindings() {
        moveHeliUpKey = bind("key.move_heli_up.desc", InputConstants.KEY_SPACE);
        openPlaneInventoryKey = bind("key.plane_inventory_open.desc", InputConstants.KEY_X);
        dropPayloadKey = bind("key.plane_drop_payload.desc", InputConstants.KEY_C);
        throttleUp = bind("key.plane_throttle_up.desc", InputConstants.KEY_UP);
        throttleDown = bind("key.plane_throttle_down.desc", InputConstants.KEY_DOWN);
        pitchUp = bind("key.plane_pitch_up.desc", InputConstants.KEY_W);
