...
Три отдельных правила, потому что «не берёт игрока в цель» и «не попадает в игрока» — разные вещи:

* игрок никогда не цель;
* выстрел **не производится**, если траектория проходит ближе 2.5 блока от игрока — именно
  баллистическая траектория, а не прямая до цели: на такой дальности дуга проходит на несколько
  блоков выше хорды;
...
Шесть скелетов вокруг убиты **18 патронами**.
